export const compositores = [
  {
    id: 'abel-luiz',
    nome: 'Abel Luiz',
    nomeCompleto: 'Abel Luiz Oliveira da Silva Machado',
    nascimento: '10/04/1982',
    falecimento: null,
  ...
  },
  {
    ...
    nome: 'Francisco Macambira',
    nomeCompleto: 'Francisco José Macambira (Chiquinho do Cavaquinho)',
    nascimento: '15/12/1937',
    falecimento: null,
    localNascimento: 'Pará (PA)',
    ...
    obras: [
      { title: 'Ave Maria dos Músicos', year: 1964 },
      { title: 'Um Cavaquinho Sobe o Morro', year: 1964 },
